defprotocol Tortoise311.Decodable do
  @moduledoc false

  def decode(data)
end

defimpl Tortoise311.Decodable, for: BitString do
...
defimpl Tortoise311.Decodable, for: List do
  def decode(data) do
    data
    |> IO.iodata_to_binary()
    |> Tortoise311.Decodable.decode()
  end
end
